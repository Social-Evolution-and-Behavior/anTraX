function export_xy_groupids(G,varargin)
...
A = table([],[],[],[],[],{},'VariableNames',{'frame','xy','area','nants','orient','id'});
...
XY=A;
report('I','Saving...')
save(G.xyfile,'XY','xy','frame','nants','area','orient','-v7.3');
report('G','Done')
