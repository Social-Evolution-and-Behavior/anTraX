...
def classify(explist, *, classifier=None, movlist: parse_movlist=None, hpc=False, hpc_options: parse_hpc_options={},
    ...
    for e in explist:
        ...
        if hpc:
            ...
            if from_expdir:
                c = axClassifier.load(classifier)
            c.predict_experiment(e, movlist=movlist, verbose=True, nw=nw, missing=missing)
...
def exportxy(explist, *, movlist=None, session=None, nw=2, mcr=False, hpc=False, hpc_options={}, missing=False, dry=False):
    """Export xy data"""
